#!/usr/bin/env python3
"""
Consolidate the Data Tab layout for better organization and usability.
"""

import os

def create_consolidated_data_panel():
    """Create a consolidated data panel with better layout."""
    ...
    print("🔧 Consolidating Data Tab layout...")
...
'''
    ...
    print("✅ Data Tab layout consolidated")
    return True

def main():
    """Main function to consolidate the Data Tab layout."""
    print("🔧 Consolidating Data Tab layout for better organization...")
    
    success = create_consolidated_data_panel()
    
    if success:
        print("\n🎉 Data Tab layout consolidated successfully!")
        print("New layout features:")
        print("✅ Two-column layout for better space utilization")
        print("✅ Left column: Data loading and recent files")
        print("✅ Right column: Feature selection and data info")
        print("✅ Bottom section: Status bar and action buttons")
        print("✅ Icons and better visual organization")
        print("✅ Compact and efficient design")
        print("\nRestart the modular GUI to see the new layout:")
        print("cd stock_prediction_gui && PYTHONPATH=.. python main.py")
    else:
        print("\n❌ Failed to consolidate Data Tab layout.")
