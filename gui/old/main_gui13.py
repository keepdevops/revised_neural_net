...
- Model management
    ...
    def on_vis_type_change(self, event):
        ...
        try:
            ...
            self.status_var.set(f"Visualization type changed to: {selected_type}")
            print(f"✅ Visualization type updated to: {selected_type}")
            
        except Exception as e:
            print(f"Error handling visualization type change: {e}")
            self.status_var.set("Error handling visualization type change")
    ...
    def show_3d_controls(self):
        ...
        try:
            ...
            ttk.Button(anim_frame, text="Refresh MPEG Files", command=self.refresh_mpeg_files).grid(row=2, column=0, sticky="ew", pady=(0, 5))
            
            # 6. Export Controls Section
            export_frame = ttk.LabelFrame(scrollable_frame, text="💾 Export Controls", padding="10")
            export_frame.grid(row=5, column=0, sticky="ew", pady=(0, 10))
            ...
            advanced_frame.grid(row=6, column=0, sticky="ew", pady=(0, 10))
            ...
            presets_frame.grid(row=7, column=0, sticky="ew", pady=(0, 10))
            ...
            status_frame.grid(row=8, column=0, sticky="ew", pady=(0, 10))
            ...
            action_frame.grid(row=9, column=0, sticky="ew", pady=(0, 10))
